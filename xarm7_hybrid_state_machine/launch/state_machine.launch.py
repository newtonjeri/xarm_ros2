...
#
# Launch file for the hybrid state machine with proper multithreading
...
def launch_setup(context, *args, **kwargs):
    ...
    # Create a multithreaded component container
...
def generate_launch_description():
    """Generate launch description with multithreaded component container."""
